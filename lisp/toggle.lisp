...
;;   (run-shell-command  "stumpish 'eval (load \"/home/vagabond/common-lisp/stump/stump.lisp/\")'")
;;   (echo-string
;;    (current-screen)
...
;; Load a file that re-defines swank and then calls it."
;;   ;; Be careful with the quotes!
;;   (run-shell-command  "stumpish 'eval (load \"/home/vagabond/common-lisp/stump/core.lisp/\")'")
;;   (echo-string
;;    (current-screen)
;;    "Starting swank. M-x slime-connect RET RET, then (in-package stumpwm)."))
;; ;;
